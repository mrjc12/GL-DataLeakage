...
class Evaluator:
    ...
    def eval(self, input_dict):
        ...
        # Check for multi-label (float type and 2D)
        if len(y_true.shape) > 1 and y_true.shape[1] > 1 and y_true.dtype != np.int64:
            ...
            return {'micro_f1': micro, 'macro_f1': macro, 'acc': micro}
